	  ...
	  return _c("div", { staticClass: "table-main-container" }, [
	    _c("table", { staticClass: "wm-table" }, [
	      ...
	      _c("thead", { attrs: { "data-cy": "table-head" } }, [
	        _c(
	          "tr",
	          { class: { "columns-movil": _vm.breakIt } },
	      ...
	      _c(
	        ...
	        _vm._l(_vm.rows, function(row, indexRow) {
	          return _c(
	            ...
	            {
	              key: indexRow,
	              class: ["row-table", { "table-movil": _vm.breakIt }]
	            },
